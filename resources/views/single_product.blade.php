...
{{--                        </div>--}}
                    ...
                    <div class="col-12 col-sm-6" >
                        ...
                        <p>{{($inventory->inventory_type=='Beverages')?$inventory->BeverageCategory->name:$inventory->SnacksCategory->name}}</p>

                        <hr>
                        <h4 style="color: #007BFF">Product Flavor</h4>

                        <div class="form-group">
                            <h5 style="font-style: italic">{{($inventory->inventory_type=='Beverages')?$inventory->BeverageFlavor->name:$inventory->SnacksFlavor->name}}</h5>
                        </div>


                        <h4 class="mt-3" style="color: #007BFF"> Product Type </h4>
                        <div class="form-group">
                            <h5 style="font-style: italic">{{($inventory->inventory_type=='Beverages')?$inventory->BeverageType->name:$inventory->SnacksType->name}}</h5>
                        </div>

                        <h4 class="mt-3" style="color: #007BFF">Product Size </h4>
                        <div class="form-group">
                            <h5 style="font-style: italic">{{($inventory->inventory_type=='Beverages')?$inventory->BeverageSize->name:$inventory->SnacksSize->name}}</h5>
                        </div>
...
{{--                            <input type="hidden" name="product_id" value="{{$inventory->id}}">--}}
                            <div class="mt-4">
                                ...
                                <button type="submit" data-name="{{$inventory->id}}" data-product="{{$inventory->name}}"  data-price="{{$inventory->price_per_carton}}" data-flavor="{{($inventory->inventory_type=='Beverages')?$inventory->BeverageFlavor->name:$inventory->SnacksFlavor->name}}" data-size="{{($inventory->inventory_type=='Beverages')?$inventory->BeverageSize->name:$inventory->SnacksSize->name}}" data-type="{{($inventory->inventory_type=='Beverages')?$inventory->BeverageType->name:$inventory->SnacksType->name}}"  class="add-to-cart btn btn-primary btn-lg btn-flat"> <i class="fas fa-cart-plus fa-lg mr-2"></i> Add To Cart</button>
...
{{--                            <a class="nav-item nav-link" id="product-rating-tab" data-toggle="tab" href="#product-rating" role="tab" aria-controls="product-rating" aria-selected="false">Rating</a>--}}
                    ...
                    <div class="tab-content p-3" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"> {{$inventory->details}} </div>
